...
\begin{table*}[t!]
	...
	\setlength\extrarowheight{1pt}
	 ...
	 \hline
	 \end{tabular}
	 \caption{Summary of three use case banks generate with \texttt{mbank}. For each bank generated, we report the variable being sampled and their ranges. We also report the hyperparameters $\epsilon$ and \texttt{mx-depth} used for the tiling. }
 	 \label{tab:sbank_comparison}
\end{table*}
...
\begin{figure}[t]
	...
	\caption{Injections true vs recovered for case study banks. $40000$ injections}

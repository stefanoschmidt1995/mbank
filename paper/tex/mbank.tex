...
The manifold with spin label \texttt{chi} uses the effective spin parameter  ${\chi_\text{eff} = \frac{m_1 s_\text{1z} + m_2 s_\text{2z}}{m_1 + m_2}}$ as coordinate. Since $\chi_\text{eff}$ is degenerate in the two spins, we choose to set $s_\text{1z} = s_\text{2z} = \chi_\text{eff}$ and all the other spin components to $0$.
...
Both banks have a minimal match requirement $MM$ of $0.97$.

...
\stefano{This is not entirely true, as for the HM metric, we don't see this trend. The problem is not in the large distances but rather in the metric accuracy}
}
	\label{fig:metric_accuracy_distance}
\end{figure}

\begin{figure}[t]
	\includegraphics{metric_accuracy_parabolic_distance}
	\caption{Same as the other but with parabolic metric
	\stefano{Those two sets of plots should be put together}
}
	\label{fig:metric_accuracy_distance}
\end{figure}

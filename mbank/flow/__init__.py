...
The module relies on `pytorch <https://pytorch.org/>`_ for a general Machine Learning library and on `glasflow.nflows.<https://github.com/bayesiains/glasflow.nflows.`_ for the flow implementation.

...
\begin{align}
	\mathcal{V} & = \int_\mathcal{\mathcal{B}_D} \dvol{\theta}{D} \; \sqrt{\det M(\theta)} \\
				& = \int_\mathcal{\mathcal{S}_\text{flow}} \dvol{\theta}{D} \; \sqrt{\det M(\theta)} \;\; \mathcal{I}_{\mathcal{B}_D}(\theta)
\end{align}
...
The expression above can be numerically evaluated by importance sampling:
%
...
\end{align}
%
The expression above gives a low variance estimation of the volume of the parameter space.

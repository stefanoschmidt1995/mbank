...
\begin{table*}[t!]
	...
	\setlength\extrarowheight{1pt}
	 ...
	 \cdashline{1-4}
	 {\bf Random} & Good coverage and injection recovery & --- & slow \\
	 \cdashline{1-4}
	 ...
	 {\bf Geo-Stochastic} & Good injection recovery &  \begin{tabular}{@{}c@{}} Tiling dependent \\ Overcovers\end{tabular}  & slow \\
 	 {\bf Tile-Stochastic} & WRITEME &  \begin{tabular}{@{}c@{}} WRITEME \\ WRITEME\end{tabular}  & slow \\
 	 {\bf Tile-Random} & WRITEME &  \begin{tabular}{@{}c@{}} WRITEME \\ WRITEME\end{tabular}  & slow \\
	 \hline
	 \end{tabular}

...
def place_random(dist, t_obj, N_points, tolerance = 0.01):
	...
	dist_sq = dist**2
	livepoints = t_obj.sample_from_tiling(N_points) #(N_points, D)
	...
	for _ in it:
		point = livepoints[np.random.choice(range(len(livepoints))),:]
		...
		#TODO: Understand whether you need this limitation... (I don't think so, otherwise it overcovers)
				#measuring metric match between livepoints and proposal
